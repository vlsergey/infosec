...
Расширенный ключ -- это матрица $\mathsf{W}$, состоящая из $4(\mathsf{N_r} + 1)$ 4-байтных вектор-столбцов, каждый столбец $i$ обозначается $\mathsf{W}[i]$.
...
\begin{algorithm}[ht]
    ...
    \begin{algorithmic}
        ...
        \ENDFOR
        \FOR{ $i = \mathsf{N_k}$ \TO $4(\mathsf{N_r} + 1) - 1$}

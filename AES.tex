...
Расширенный ключ –- это матрица $\mathsf{W}$, состоящая из $4 \cdot (\mathsf{Nr} + 1)$ 4-байтных вектор-столбцов, где каждый столбец $i$ обозначается $\mathsf{W}[i]$.

...
\begin{table}[h!]
    ...
    \resizebox{\textwidth}{!}{ \begin{tabular}{|l|c|c|c|c|}
        \hline
        & \multirow{2}{*}{\parbox{1.5cm}{Блоковые шифры, $K$}} & \multicolumn{3}{|c|}{Схема ЭЦП} \\
        \cline{3-5}
        & & \parbox{1.5cm}{RSA, $n$} & \parbox{2.3cm}{Эллипт. кривые, порядок точки} & \parbox{3.5cm}{Эль-Гамаль $\mod p$: модуль / порядок (под)группы} \\
        \hline \hline
...
\subsection*{Скорость вычисления ЭЦП}

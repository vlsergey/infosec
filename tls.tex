...
Одноразовые метки $N_C, N_S$ состоят из 32 байт. Первые 4 байта -- текущее время, оставшиеся байты -- псевдослучайные числа. Псевдослучайная битовая строка формируется криптографическим псевдослучайным генератором чисел $PRF$.

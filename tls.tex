...
Одноразовая метка $N_C$ состоит из 32 байт. Первые 4 байта содержат текущее время (gmt_unix_time), оставшиеся байты -- псевдослучайные. Псевдослучайная битовая строка формируется криптографически стойким генератором псевдослучайных чисел.
